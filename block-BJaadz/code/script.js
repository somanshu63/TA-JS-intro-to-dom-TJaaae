...
let hrImgArray = Array.from(hrImg); 
...
allHrsArray.map((elm) => elm.style.borderStyle = "dashed");
...
let paraForBox2 = document.createElement("p");
paraForBox2.innerText = "Append inserts as last child" ;
let box2 = document.querySelector(".two");
box2.append(paraForBox2);

// Select box 3 and prepend a new paragraph element with content "Prepend inserts as first child" just before hr element.
let paraForBox3 = document.createElement("p");
paraForBox3.innerText = "Prepend inserts as first child";
...
box1.children[0].style.fontSize = "0.8rem";
...
for(let i = 0; i < allBoxes.length; i++){
  if([i] % 2 == 0){
    allBoxes[i].style.background = "aliceblue";
  }
}
